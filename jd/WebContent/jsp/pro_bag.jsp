...
<html>
    <head>
        ...
        <title>万宝龙MONTBLANC大班软皮粒纹系列男士黑色牛皮拉链双肩包113950</title>
    ...
    <body>
        ...
        <div id="body">
            ...
            <div class="div2">
                <div>
                    <a href="">礼品</a><span>></span>
                    <a href="">奢侈品</a><span>></span>
                    <a href="">箱包</a><span>></span>
                    <a href="">万宝龙（MONTBLANC）</a><span>></span>
                    <a href="">万宝龙 </a>
                    <a href="" class="shopname">万宝龙京东自营专区</a><span> | </span>
            ...
            <div class="div3">
                <div>
                    <div class="left">
                        <div id="back_g" class="back_bag" style=""></div>
                        <br>
                        <img src="../product/bag1.jpg" alt="" onmouseover="change_bk('p1','bag')">
                        <img src="../product/bag2.jpg" alt="" onmouseover="change_bk('p2','bag')">
                        <img src="../product/bag3.jpg" alt="" onmouseover="change_bk('p3','bag')">
                        <img src="../product/bag4.jpg" alt="" onmouseover="change_bk('p4','bag')">
                        <img src="../product/bag5.jpg" alt="" onmouseover="change_bk('p5','bag')">
                        <br><br><br>
                    ...
                    <div class="right">
                    <br><br><br>
                        <p>万宝龙MONTBLANC大班软皮粒纹系列男士黑色牛皮拉链双肩包113950</p>
                        <div>
                            <span>【15天价保，一级授权经销商，全国联保】【荣耀直供，支持7天无理由退换货】【赠：品牌礼包】</span>
                            <br><span>此商品将于2019-07-21,10点参加闪购特卖 &nbsp;&nbsp;</span><a href="">万宝龙奢侈品专场</a>
                            ...
                            <span>免运费</span>
                            <br>
                            <span class="sendpath">由万宝龙专卖店从 上海 发货, 并提供售后服务. 今日17:00前完成下单，预计7月21日20:00前发货，7月24日24:00前送达</span>
                           
                            <br>
                           	 选择尺码 &nbsp;&nbsp;
                            <a class="b" href="">113950</a>
                            <a class="b" href="">111137</a>
                            <br>
                            增值保障 &nbsp;&nbsp;
                            <a class="b" href="">箱包奢护 ￥199 </a>
                            <a class="b" href="">首月意外保 ￥9.9 </a>
                            <br>
                            京东服务 &nbsp;&nbsp;
                            <a class="b" href="">深度翻新养护 ￥39</a>
                            <a class="b" href="">一年意外维修 ￥39</a>
                            <br>
                            白条分期 &nbsp;&nbsp;
                            <a class="b" href="" title="无服务费">不分期</a>
                            <a class="b" href="" title="含服务费：费率0.5%起，￥7.6起×3期">￥1911.59起×3期</a>
                            <a class="b" href="" title="含服务费：费率0.5%起，￥7.6起×6期">￥969.9起×6期</a>
                            <a class="b" href="" title="含服务费：费率0.5%起，￥7.6起×12期">￥499.12起×12期</a>
                            <a class="b" href="" title="含服务费：费率0.5%起，￥7.6起×24期">￥263.59起×24期 </a>
                            <br>
                            <span class="raise">增值保障不支持一键打白条</span> 
                            <br>
                            <form action="../login.do?method=addCar" method="post">
                                <input name="sname" value="万宝龙MONTBLANC大班软皮粒纹系列男士黑色牛皮拉链双肩包113950" class="name">
						                           件数：<input id="number" type="text" value="1" width="40px" name="shopno">
						                           总价：<input id="total_price" type="text" value="5650.00" width="40px" name="totalprice" readonly>
                                <input type="button" value=" + " onclick="add('5650.00')">
                                <input type="button" value=" - " onclick="mul('5650.00')">
                                <input type="submit" value="加入购物车" class="addShop">
                            </form>
                            <br>
                            温馨提示 ·支持7天无理由退货 ·此商品不可使用东券
                            <br>
                        </div>
                    </div>
                </div>    
